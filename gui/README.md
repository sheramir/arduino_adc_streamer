...
- `PressureMapWidget(QWidget)`
  ...
  - `configure_arrow(...)`, `configure_markers(...)`, `configure_package_boundary(...)`, `configure_intensity(...)`, `configure_mirror(...)` — update visualization settings and refresh if changed.
