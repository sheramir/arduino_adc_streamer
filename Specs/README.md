...
- `PRESSURE_MAP_TAB_SPEC.md` — Pressure Map tab specification: integrated live processing, shear/normal derivation, pressure-map rendering, settings persistence, and acceptance criteria.
