...
# First implementation handles one 5-channel piezo package: T/B/C/L/R.
...
# Rectangular moving-sum integration defaults.
...
# Evaluation tab display defaults and control ranges.
